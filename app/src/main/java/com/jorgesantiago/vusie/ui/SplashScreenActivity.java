...
public class SplashScreenActivity extends DaggerAppCompatActivity {
    ...
    protected void onResume() {
        ...
        repositoryRefreshSubscription = articleViewModel.notifyWhenRefreshIsComplete()
    ...
    private void setupAnimations() {
        // we want the colorful vusie loading bars to always translate across the entire width of any screen size the app may be running on
        ...
        // we want the bar to translate the entire width of the screen, and to actually go off the edge of the screen -- we only measure one view because they are all the same size
        float distanceToTravel = DisplayUtility.getScreenWidthInPixels(this) + DisplayUtility.getViewWidthInPixels(this, loadingBlue);
        ...
        // TODO see if there is way to clean up all these translations, make more concise, readable? -- maybe make an AnimationUtility class to take all this logic out of activity
