...
/**
 * Our Article database entity object. We map our {@link NewsApiArticleResponse} into an {@link ArticleDatabaseEntity}
 * to store in our Room database.
 * <p>
 * This class is almost identical to our {@link NewsApiArticleResponse} but instead of making this
...
public class ArticleDatabaseEntity {
     ...
     */
    public static ArticleDatabaseEntity convertApiResponseToDbEntity(final NewsApiArticleResponse apiResponse) {
